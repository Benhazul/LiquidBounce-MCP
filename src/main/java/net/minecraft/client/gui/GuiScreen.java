...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void handleComponentHover(IChatComponent component, int x, int y)
    {
        if (component != null
                ...
                && ComponentOnHover.INSTANCE.handleEvents())
        {
    ...
    public void drawBackground(int tint)
    {
        ...
        if (ClientConfiguration.INSTANCE.getCustomBackground())
        {
            ...
            if (background == null)
            {
                ...
                worldRenderer.pos(0, this.height, 0).endVertex();
            ...
            {
                background.drawBackground(this.width, this.height);
            }
